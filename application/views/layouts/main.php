  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="<?php echo $home; ?>"><a href="<?php echo base_url();?>users/calculator">Calculator<span class="sr-only">(current)</span></a></li>
        <li class="<?php echo $home; ?>"><a href="<?php echo base_url();?>users/adventCalender">Advent Calender<span class="sr-only">(current)</span></a></li>
